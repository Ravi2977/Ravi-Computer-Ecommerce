    ...
    <div className='p-10 rounded-lg'>
            <div className='flex justify-center flex-col items-center'>
                ...
                <div className='flex justify-end ' style={{ width: 600 }}>
                    <p>Don't have an Account <span><a className='text-blue-900 underline underline-offset-1' href="/signin">Sign-up </a>here</span></p>
                </div>
                <button className='mt-10 mb-3 border py-4 px-10 rounded-xl font-semibold text-white shadow-2xl build button' >Log in</button>
            </div>
        </div>
  )
}
